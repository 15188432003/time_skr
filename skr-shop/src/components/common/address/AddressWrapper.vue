<template>
  <div class="address_wrapper">
    <div class="add_top">
      <h2>收货地址</h2>
      <div class="svg_wrapper" @click="addShow">
        <svg-icon
          icon-class="close"
          className="icon"
          width="24px"
    ...
    <div class="add_body">
      <el-form :model="tableData">
        ...
        <div class="btn">
          <el-form-item>
            <el-button @click="addShow" class="ret">返回</el-button>
            <el-button class="keep" @click="keepAddress">保存地址</el-button>
          </el-form-item>
        </div>
      </el-form>
    </div>
