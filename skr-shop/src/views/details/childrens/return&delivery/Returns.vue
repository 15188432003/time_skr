        ...
        <li>
          ...
          <div class="right">
            <ul>
              <li>
                <p>
                  至于能否以售后服务(A/S)为标准，根据品牌和商品不同，所以有关咨询请通过doubicon客服中心咨询。
                </p>
              </li>
              <li>
                <p>
                  因商品不良而发生的退货、更换、A/S、退款、质量保证及损害赔偿等事项，可以根据消费者纠纷解决标准(公平交易委员会告示)接受。
                </p>
              </li>
            </ul>
          </div>
