    ...
    children:
      [
        ...
        },
        {
          path: "shopClass",
          name: "shopClass",
          component: () => import("../views/shop/shopClass/index.vue"),
...

        {
          path: 'addBrand/:id',
          name: 'addBrand',
          component: () => import('@/views/shop/brand/addBrand'),
          meta: {title: '添加品牌'},
          props: true,
          hidden:true
        },

        {path:'/shop',redirect:'/shop/shopList'}
      ]
  },
  {
    path: "/market",
    ...
    children: [
      {
        path: "marketCoupon",
        name: "marketCoupon",
        component: () => import("@/views/market/marketCoupon/index"),
        meta: { title: "优惠券列表", icon: 'sms-coupon' }
      },
      {
        path: 'couponDetail',
        name: 'couponDetail',
        component: () => import("@/views/market/marketCoupon/detail.vue"),
      },
      {
        path: "editCoupon",
        name: "editCoupon",
        component: () => import('@/views/market/marketCoupon/edit.vue')
      },
      {
        path: 'addCoupon',
        name: 'addCoupon',
        component: () => import('@/views/market/marketCoupon/add.vue')
      },
      {
        path: "market",
        name: '秒杀活动列表',
...
// if(to.path==='/shop/addShop' && from.path==='/shop/shopList'){
//   console.log('luyoushouwei');
//   }
// })
